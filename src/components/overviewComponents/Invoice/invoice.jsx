...
const Invoice = () => {
    ...
    const All = () => {
        return (
            <>
                <div className="bg-blue-500 relative justify-between align-center overflow-hidden w-full h-full rounded-lg p-7 text-white bg-right bg-no-repeat" style={{ backgroundImage: `url(${VectorBG})`, position: 'relative' }}>
                    <h1 className="text-2xl pb-7">All Invoices</h1>
                    <form action="" className="flex gap-3 text-gray-400-500">
                        <div className="item">
                            <label htmlFor="">
                                Begin Date
                            </label><br />
                            ...
                            <select name="" id="" className="border rounded text-gray-400">
    ...
    switch (tab) {
        ...
        case "Data":
            return <Data tab={tab} setTab={setTab} products={products} selectedCount={selectedCount} setSelectedCount={setSelectedCount} selectedRows={selectedRows} setSelectedRows={setSelectedRows} />
        case 'Refund':
            console.log(selectedRows);

            return <Refund tab={tab} setTab={setTab} products={products} selectedCount={selectedCount} setSelectedCount={setSelectedCount} selectedRows={selectedRows} setSelectedRows={setSelectedRows} />
    }
}
